...
kind create cluster --name cilium-cluster --config cilium-kimd.yaml --image kindest/node:v1.30.0@sha256:047357ac0cfea04663786a612ba1eaba9702bef25227a794b52890dd8bcd692e
...
echo -e "*******************************************************************************************************************"
tput setaf 3
kubectl label node cilium-cluster-worker ingress-ready=true
...
echo -e "\n \n*******************************************************************************************************************"
echo -e "Download the Cilium files and Install Cilium using Helm"
echo -e "*******************************************************************************************************************"
tput setaf 3
curl -LO https://github.com/cilium/cilium/archive/main.tar.gz
tar xzf main.tar.gz
helm install cilium ./cilium-main/install/kubernetes/cilium \
